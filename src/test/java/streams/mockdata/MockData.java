...
public class MockData {
    ...
    public static List<Person> getPeople() throws IOException {
        InputStream inputStream = Resources.getResource("streams/people.json").openStream();
    ...
    public static List<Car> getCars() throws IOException {
        InputStream inputStream = Resources.getResource("streams/cars.json").openStream();
        String json = IOUtils.toString(inputStream, StandardCharsets.UTF_8);
